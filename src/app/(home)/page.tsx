...
const GanttView = () => {
  ...
  const handleRemoveFeature = (id: string) =>
    setFeatures((prev) => prev.filter((feature: any) => feature.id !== id));
  ...
  return (
    ...
    >
      <GanttSidebar>
        {(Object.entries(sortedGroupedFeatures) as [string, any[]][]).map(
          ([group, features]) => (
            <GanttSidebarGroup
              key={group}
              name={group}
            ...
            {features
              ...
              .map((feature, index) => (
                ...
                >
                  ...
                  />
                  <p className="flex-1 m-0 font-medium text-sm">
                    {feature.name}
                  </p>
                  {feature.owner && (
...
const KanbanView = () => {
  const [features, setFeatures] = useState(
    exampleFeatures.map((feature: any) => ({
      ...feature,
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <div
              className="right-0 bottom-0 absolute rounded-full ring-2 ring-background w-2 h-2"
              style={{
...
const Example = () => {
  ...
  return (
    <Tabs
      className="gap-0 divide-y size-full not-prose"
      defaultValue="gantt"
    >
