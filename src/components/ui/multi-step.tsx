...
>(({ className = "", ...props }, ref) => {
  ...
  const builtIndicatorClasses = cn(
    "justify-center disabled:opacity-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium text-sm whitespace-nowrap transition-colors disabled:pointer-events-none",
    indicatorClasses,
    className
  );
  ...
  return (
    <div
      ref={ref}
      className={builtIndicatorClasses}
      {...props}
    >
      {state === "completed" ? <Check className="w-4 h-4" /> : stepIndex}
    </div>
  );
});
...
>(({ children, className = "", onClick, ...props }, ref) => {
  ...
  const triggerClasses = cn(
    "inline-flex justify-center items-center disabled:opacity-50 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 font-medium text-sm transition-colors cursor-pointer disabled:pointer-events-none",
    className
  );
...
>(({ children, className = "", ...props }, ref) => {
  ...
  const titleClasses = cn(
    "font-medium text-primary text-sm text-left leading-none",
